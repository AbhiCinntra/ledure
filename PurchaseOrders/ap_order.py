    ...
    while skip != "": 
        ...
        for opt in opts['value']:
            ...
            if mycursor.rowcount != 1:
                ...
                # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                seriesNameURL = f"http://35.154.67.167:8000/Ledure/General/SeriesName.xsjs?DBName=LEDURE_LIVE_300323&DocEntry={DocEntry}&ObjType=18"
                print(seriesNameURL)
