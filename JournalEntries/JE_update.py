...
print("<><><><><><><><><><><>><><><><><><")
print("===== Login SAP ====")
data = { "CompanyDB": "LEDURE_LIVE_300323", "Password": "L#d0345^%$", "UserName": "uneecloud\\led.manager", "SessionId": "7c85460c-c15a-11ed-8000-005056a40bab", "at": "2023-03-13 10:19:30", "sapurl": "https://analytics103u.uneecloud.com:50000/b1s/v1" }
...
if True:
    ...
    while skip != "":
        ...
        # baseUrl = f"/JournalEntries?$orderby= JdtNum asc&$filter = JdtNum eq {lastEntryNumber}&$skip={skip}"
