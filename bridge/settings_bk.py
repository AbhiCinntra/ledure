...
def SAPSESSIONNEW(inp):
    ...
    if diff_minutes < 25:
        #print("valid")
        session.cookies.set('B1SESSION', data['SessionId'], path='/', domain='analytics103u.uneecloud.com')
        #return data
        return session
        ...
        ses_json = json.loads(ses.text)
        session.cookies.set('B1SESSION', ses_json['SessionId'], path='/', domain='analytics103u.uneecloud.com')
        data['SessionId'] = ses_json['SessionId']
        data['at'] = current_dtime
